...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/guohe/workspace/ffmpeg_build_lib//build --disable-shared --enable-pthreads --enable-gpl --enable-version3 --enable-nonfree --enable-static --enable-ffmpeg --disable-ffplay --enable-ffprobe --disable-ffserver --disable-doc --disable-symver --enable-avdevice --enable-avfilter --enable-small --enable-asm --enable-neon --cross-prefix=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=linux --arch=arm --enable-cross-compile --sysroot=/Users/guohe/Android/android-ndk/platforms/android-16/arch-arm --enable-parsers --disable-encoders --enable-encoder=h264 --enable-encoder=mp3 --enable-encoder=aac --enable-encoder=pcm_s16le --disable-decoders --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=pcm_s16le --disable-network --enable-protocols --enable-protocol=file --enable-filters --extra-cflags='-mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a' --enable-encoder=aac --enable-decoder=aac --enable-gpl --enable-encoder=libx264 --enable-libx264 --extra-cflags=-I/Users/guohe/workspace/ffmpeg_build_lib//build/include --extra-ldflags=-L/Users/guohe/workspace/ffmpeg_build_lib//build/lib
prefix=/Users/guohe/workspace/ffmpeg_build_lib//build
...
ARCH=arm
INTRINSICS=none
CC=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
CXX=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -isysroot /Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a -I/Users/guohe/workspace/ffmpeg_build_lib//build/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a -I/Users/guohe/workspace/ffmpeg_build_lib//build/include -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/Users/guohe/workspace/ffmpeg_build_lib//build/lib  --sysroot=/Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -isysroot /Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
