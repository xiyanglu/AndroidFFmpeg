			...
			public void onClick(View arg0) {
				...
				if (mCamera != null) {
					if (isRecording) {
						...
						Toast.makeText(EncoderActivity.this, "encode done",
								Toast.LENGTH_SHORT).show();
						isRecording = false;
					} else {
						mTakeButton.setText("Stop");
						Log.d(TAG, "width:" + mCamera.getParameters().getPreviewSize().width);
						Log.d(TAG, "height:" + mCamera.getParameters().getPreviewSize().height);
