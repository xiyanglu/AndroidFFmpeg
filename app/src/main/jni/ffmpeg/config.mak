...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build --disable-shared --enable-pthreads --enable-gpl --enable-version3 --enable-nonfree --enable-static --enable-ffmpeg --disable-ffplay --enable-ffprobe --disable-ffserver --disable-doc --disable-symver --enable-avdevice --enable-avfilter --enable-small --enable-asm --enable-neon --cross-prefix=/Users/guohe/Android/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --target-os=linux --arch=arm --enable-cross-compile --sysroot=/Users/guohe/Android/android-ndk/platforms/android-16/arch-arm --enable-parsers --disable-encoders --enable-encoder=h264 --enable-encoder=mp3 --enable-encoder=aac --enable-encoder=pcm_s16le --disable-decoders --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=pcm_s16le --disable-network --enable-protocols --enable-protocol=file --enable-filters --extra-cflags='-mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a' --enable-encoder=aac --enable-decoder=aac --enable-gpl --enable-encoder=libx264 --enable-libx264 --extra-cflags=-I/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build/include --extra-ldflags=-L/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build/lib
prefix=/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build
...
CFLAGS=  -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a -I/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -mfloat-abi=softfp -mfpu=vfpv3-d16 -marm -march=armv7-a -I/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build/include -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -L/Users/guohe/GitHub/AndroidFFmpeg/app/src/main/jni//build/lib  --sysroot=/Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -isysroot /Users/guohe/Android/android-ndk/platforms/android-16/arch-arm -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
